...
#Clase para encapsular las muestras del dataset breakhis, se utiliza para el entrenamiento
#de la red, con cualquiera de los scripts de entrenamiento "train.py" o "train_v2.py"
...
#Clase para encapsular las muestras de input de la red. Se utiliza para la predicción de nuevas
#imágenes en la aplicación HACHT
class BreakHisWork(Dataset):
	def __init__(self, img, image_size):
		...
		# Self channels
		self.channels = cv2.IMREAD_COLOR
